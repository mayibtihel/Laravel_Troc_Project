...
<!-- Mirrored from themes.pixelstrap.com/fastkart/back-end/order-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Sep 2023 12:45:46 GMT -->
                                                    ...
                                                    <table class="table cart-table table-borderless">
                                                        ...
                                                        <tbody>
                                                            <tr class="table-order">
                                                                <td>
                                                                    <a href="javascript:void(0)">
                                                                        <img src="{{Vite::asset('resources/backassets/assets/images/profile/1.jpg')}}"
                                                            ...
                                                            <tr class="table-order">
                                                                <td>
                                                                    <a href="javascript:void(0)">
                                                                        <img src="{{Vite::asset('resources/backassets/assets/images/profile/2.jpg')}}"
                                                                            class="img-fluid blur-up lazyload" alt="">
                                                                    </a>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr class="table-order">
                                                                <td>
                                                                    <a href="javascript:void(0)">
                                                                        <img src="{{Vite::asset('resources/backassets/assets/images/profile/3.jpg')}}"
                                                                            class="img-fluid blur-up lazyload" alt="">
                                                                    </a>
                                                                </td>
                                                                <td>
                                                ...
                                                <div class="order-success">
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="delivery-sec">
                                                            ...
                                                            <a href="/admin/order-tracking">track order</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<!-- Mirrored from themes.pixelstrap.com/fastkart/back-end/order-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Sep 2023 12:45:48 GMT -->
</html>

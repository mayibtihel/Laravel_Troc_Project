                                        ...
                                        <table class="table all-package order-table theme-table" id="table_id">
                                            ...
                                            @foreach ($reclamations as $reclamations)
                                                <tr data-bs-toggle="offcanvas" href="#order-details">
                                                    ...
                                                    <td>{{ $reclamations->title }}</td>
                                                    <td>{{ $reclamations->user_id }}</td>

                                                    <td>  <img width="150px" height="150px" src="/images/{{ $reclamations->image }}" alt="" >
                                                    <td>{{ $reclamations->description }}</td>


                                                    <td>

                                                        <form method="POST" action="{{ route('reclamation.clear', ['id' => $reclamations->id]) }}">
                                                            @csrf
                                                            @method('DELETE')

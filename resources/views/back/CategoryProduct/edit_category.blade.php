                            ...
                            <div class="col-sm-8 m-auto">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('categories.update', ['id' => $cat->id]) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="mb-4 row align-items-center">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="title" class="form-control" placeholder="CategoryProduct Title" value="{{ $cat->title }}">
                                            ...
                                            <div class="mb-4 row align-items-center">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="bs-example">
                                                        <textarea type="text" name="description" class="form-control" placeholder="Description" rows="6">{{ $cat->description }}</textarea>
                                                        @error('description')
                                                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                                        @enderror
                                                    </div>

...
<!-- Mirrored from themes.pixelstrap.com/fastkart/back-end/media.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Sep 2023 12:45:45 GMT -->
                                        ...
                                        <div>
                                            <div class="library-box">
                                                ...
                                                <label for="myCheckbox1">
                                                    <div>
                                                        <img src="{{Vite::asset('resources/backassets/assets/images/product/1.png')}}"
                                        ...
                                        <div>
                                            <div class="library-box">
                                                ...
                                                <label for="myCheckbox2">
                                                    <div>
                                                        <img src="{{Vite::asset('resources/backassets/assets/images/product/2.png')}}"
                                                            class="img-fluid bg-img bg_size_content" alt="">
                                                    </div>
                                                    <div class="dropdown">
                                                        <a class="" href="#" role="button" id="dropdownMenuLink"
                                        ...
                                        <div>
                                            <div class="library-box">
                                                ...
                                                <label for="myCheckbox3">
                                                    <div>
                                                        <img src="{{Vite::asset('resources/backassets/assets/images/product/3.png')}}"
                                                            class="img-fluid bg-img bg_size_content" alt="">
                                                    </div>
                                                    <div class="dropdown">
                                                        <a class="" href="#" role="button" id="dropdownMenuLink"
                                        ...
                                        <div>
                                            <div class="library-box">
                                                ...
                                                <label for="myCheckbox4">
                                                    <div>
                                                        <img src="{{Vite::asset('resources/backassets/assets/images/product/4.png')}}"
                                                            class="img-fluid bg-img bg_size_content" alt="">
                                                    </div>
                                                    <div class="dropdown">
                                                        <a class="" href="#" role="button" id="dropdownMenuLink"
                                        ...
                                        <div>
                                            <div class="library-box">
                                                ...
                                                <label for="myCheckbox5">
                                                    <div>
                                                        <img src="{{Vite::asset('resources/backassets/assets/images/product/5.png')}}"
                                                            class="img-fluid bg-img bg_size_content" alt="">
                                                    </div>
                                                    <div class="dropdown">
                                                        <a class="" href="#" role="button" id="dropdownMenuLink"
                                        ...
                                        <div>
                                            <div class="library-box">
                                                ...
                                                <label for="myCheckbox6">
                                                    <div>
                                                        <img src="{{Vite::asset('resources/backassets/assets/images/product/6.png')}}"
                                                            class="img-fluid bg-img bg_size_content" alt="">
                                                    </div>
                                                    <div class="dropdown">
                                                        <a class="" href="#" role="button" id="dropdownMenuLink"
                                        ...
                                        <div>
                                            <div class="library-box">
                                                ...
                                                <label for="myCheckbox7">
                                                    <div>
                                                        <img src="{{Vite::asset('resources/backassets/assets/images/product/7.png')}}"
                                                            class="img-fluid bg-img bg_size_content" alt="">
                                                    </div>
                                                    <div class="dropdown">
                                                        <a class="" href="#" role="button" id="dropdownMenuLink"
                                        ...
                                        <div>
                                            <div class="library-box">
                                                ...
                                                <label for="myCheckbox8">
                                                    <div>
                                                        <img src="{{Vite::asset('resources/backassets/assets/images/product/8.png')}}"
                                                            class="img-fluid bg-img bg_size_content" alt="">
                                                    </div>
                                                    <div class="dropdown">
                                                        <a class="" href="#" role="button" id="dropdownMenuLink"
                                        ...
                                        <div>
                                            <div class="library-box">
                                                ...
                                                <label for="myCheckbox9">
                                                    <div>
                                                        <img src="{{Vite::asset('resources/backassets/assets/images/product/9.png')}}"
                                                            class="img-fluid bg-img bg_size_content" alt="">
                                                    </div>
                                                    <div class="dropdown">
                                                        <a class="" href="#" role="button" id="dropdownMenuLink"
                                        ...
                                        <div>
                                            <div class="library-box">
                                                ...
                                                <label for="myCheckbox11">
                                                    <div>
                                                        <img src="{{Vite::asset('resources/backassets/assets/images/product/14.png')}}"
                                                            class="img-fluid bg-img bg_size_content" alt="">
                                                    </div>
                                                    <div class="dropdown">
                                                        <a class="" href="#" role="button" id="dropdownMenuLink"
                                        ...
                                        <div>
                                            <div class="library-box">
                                                ...
                                                <label for="myCheckbox12">
                                                    <div>
                                                        <img src="{{Vite::asset('resources/backassets/assets/images/product/13.png')}}"
                                                            class="img-fluid bg-img bg_size_content" alt="">
                                                    </div>
                                                    <div class="dropdown">
                                                        <a class="" href="#" role="button" id="dropdownMenuLink"
                                        ...
                                        <div>
                                            <div class="library-box">
                                                ...
                                                <label for="myCheckbox13">
                                                    <div>
                                                        <img src="{{Vite::asset('resources/backassets/assets/images/product/16.png')}}"
                                                            class="img-fluid bg-img bg_size_content" alt="">
                                                    </div>
                                                    <div class="dropdown">
                                                        <a class="" href="#" role="button" id="dropdownMenuLink"
                                        ...
                                        <div>
                                            <div class="library-box">
                                                ...
                                                <label for="myCheckbox14">
                                                    <div>
                                                        <img src="{{Vite::asset('resources/backassets/assets/images/product/20.png')}}"
                                                            class="img-fluid bg-img bg_size_content" alt="">
                                                    </div>
                                                    <div class="dropdown">
                                                        <a class="" href="#" role="button" id="dropdownMenuLink"
...
<!-- Mirrored from themes.pixelstrap.com/fastkart/back-end/media.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Sep 2023 12:45:46 GMT -->
</html>

                        ...
                        <table class="table table-wishlist">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="image product-thumbnail"><img src="{{Vite::asset('resources/frontassets/assets/imgs/shop/product-4-1.jpg')}}" alt="#" /></td>
                                    <td class="product-des product-name">
                                ...
                                <tr>
                                    ...
                                    <td class="image product-thumbnail"><img src="{{Vite::asset('resources/frontassets/assets/imgs/shop/product-5-1.jpg')}}" alt="#" /></td>
                                    <td class="product-des product-name">

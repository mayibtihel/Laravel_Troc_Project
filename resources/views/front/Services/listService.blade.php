                            ...
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="shop-product-right">
                                        <img class="default-img" src="{{Vite::asset($service->image)}}" alt="" />
{{--                                        <img class="hover-img" src="{{Vite::asset('resources/frontassets/assets/imgs/shop/product-2-2.jpg')}}" alt="" />--}}
                            ...
                            <div class="product-content-wrap">
                                <div class="product-category">
                                    <a href="shop-grid-right">{{$service->category_service->title}}</a>
                                </div>
                                <h2><a href="{{ URL::to( '/service/' . $service->id)  }}">{{$service->name}}</a></h2>
                                ...
                                <div>
                                    <span class="font-small text-muted">By <a href="vendor-details-1">{{$service->user->username}}</a></span>
                                </div>
            ...
            <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
                <div class="sidebar-widget widget-category-2 mb-30">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="{{ URL::to( '/services/' . $category->id)  }}"> <img src="{{Vite::asset($category->image)}}"  alt="" />{{$category->title}}</a><span class="count">{{sizeof($category->services)}}</span>
                        </li>
                        @endforeach
                    </ul>
                </div>

        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> <a href="shop-grid-right">Recipes</a> <span></span> Best smartwatch 2022: the top wearables you can buy today
                </div>
            </div>
        </div>
                            ...
                            <div class="col-lg-9">
                                <div class="single-page pt-50 pr-30">
                                    <div class="single-header style-2">
                                        <div class="row">
                                            <div class="col-xl-10 col-lg-12 m-auto">
                                                ...
                                                <h2 class="mb-10">Best smartwatch 2022: the top wearables you can buy today</h2>
                                                <div class="single-header-meta">
                                                    <div class="entry-meta meta-1 font-xs mt-15 mb-15">
                                                        <a class="author-avatar" href="#">
                                                            <img class="img-circle" src="{{Vite::asset('resources/frontassets/assets/imgs/blog/author-1.png')}}" alt="" />
                                                        </a>
                                                    ...
                                                    <div class="social-icons single-share">
                                                        <ul class="text-grey-5 d-inline-block">
                                                            <li class="mr-5">
                                                                <a href="#"><img src="{{Vite::asset('resources/frontassets/assets/imgs/theme/icons/icon-bookmark.svg')}}" alt="" /></a>
                                                            </li>
                                                            <li>
                                                                <a href="#"><img src="{{Vite::asset('resources/frontassets/assets/imgs/theme/icons/icon-heart-2.svg')}}" alt="" /></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                    ...
                                    <figure class="single-thumbnail">
                                        <img src="{{Vite::asset('resources/frontassets/assets/imgs/blog/blog-19.png')}}" alt="" />
                                    </figure>
                                    <div class="single-content">
                                        <div class="row">
                                            <div class="col-xl-10 col-lg-12 m-auto">
                                                ...
                                                <img class="mb-30" src="{{Vite::asset('resources/frontassets/assets/imgs/blog/blog-21.png')}}" alt="" />
                                                ...
                                                <div class="entry-bottom mt-50 mb-30">
                                                    <div class="tags w-50 w-sm-100">
                                                        <a href="blog-category-big" rel="tag" class="hover-up btn btn-sm btn-rounded mr-10">deer</a>
                                                        <a href="blog-category-big" rel="tag" class="hover-up btn btn-sm btn-rounded mr-10">nature</a>
                                                        <a href="blog-category-big" rel="tag" class="hover-up btn btn-sm btn-rounded mr-10">conserve</a>
                                                    </div>
                                                    <div class="social-icons single-share">
                                                        <ul class="text-grey-5 d-inline-block">
                                                            <li><strong class="mr-10">Share this:</strong></li>
                                                            <li class="social-facebook">
                                                                <a href="#"><img src="{{Vite::asset('resources/frontassets/assets/imgs/theme/icons/icon-facebook.svg')}}" alt="" /></a>
                                                            </li>
                                                            <li class="social-twitter">
                                                                <a href="#"><img src="{{Vite::asset('resources/frontassets/assets/imgs/theme/icons/icon-twitter.svg')}}" alt="" /></a>
                                                            </li>
                                                            <li class="social-instagram">
                                                                <a href="#"><img src="{{Vite::asset('resources/frontassets/assets/imgs/theme/icons/icon-instagram.svg')}}" alt="" /></a>
                                                            </li>
                                                            <li class="social-linkedin">
                                                                <a href="#"><img src="{{Vite::asset('resources/frontassets/assets/imgs/theme/icons/icon-pinterest.svg')}}" alt="" /></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="author-bio p-30 mt-50 border-radius-15 bg-white">
                                                    <div class="author-image mb-30">
                                                        <a href="author"><img src="{{Vite::asset('resources/frontassets/assets/imgs/blog/author-1.png')}}" alt="" class="avatar" /></a>

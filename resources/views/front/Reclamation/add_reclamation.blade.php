                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card-header-2">
                                            <h5> Send Reclamation</h5>
                                        </div>


                                        <form class="theme-form theme-form-2 mega-form" action="{{route('reclamations.store')}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <button type="submit" class="btn btn-primary ml-3">Send Reclamation</button>

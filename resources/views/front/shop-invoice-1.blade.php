...
<body>
    <div class="invoice invoice-content invoice-1">
        <div class="back-top-home hover-up mt-30 ml-30">
            <a class="hover-up" href="index"><i class="fi-rs-home mr-5"></i> Homepage</a>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="invoice-inner">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="invoice-name">
                                            <div class="logo">
                                                <a href="index"><img src="{{Vite::asset('resources/frontassets/assets/imgs/theme/logo-light.svg')}}" alt="logo" /></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="invoice-number">
                                            ...
                                            <p class="invoice-addr-1">
                                                ...
                                                <a href="https://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f092999c9c999e97b0be958384bd918284de939f9d">[email&#160;protected]</a> <br />
                        ...
                        <div class="invoice-btn-section clearfix d-print-none">
                            <a href="javascript:window.print()" class="btn btn-lg btn-custom btn-print hover-up"> <img src="{{Vite::asset('resources/frontassets/assets/imgs/theme/icons/icon-print.svg')}}" alt="" /> Print </a>
                            <a id="invoice_download_btn" class="btn btn-lg btn-custom btn-download hover-up"> <img src="{{Vite::asset('resources/frontassets/assets/imgs/theme/icons/icon-download.svg')}}" alt="" /> Download </a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Vendor JS-->
    @vite(['resources/frontassets/assets/js/vendor/jquery-3.6.0.min.js'])
    <!-- Invoice JS -->
    @vite(['resources/frontassets/assets/js/invoice/jspdf.min.js'])
    @vite(['resources/frontassets/assets/js/invoice/invoice.js'])
</body>


<!-- Mirrored from wp.alithemes.com/html/nest/demo/shop-invoice-1 by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Sep 2023 16:52:35 GMT -->
</html>
